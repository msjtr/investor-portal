 ...
 * تم التحديث ليدعم واجهات المصادقة ولوحة التحكم
 */
const Icons = {
    // --- أيقونات النماذج (Forms) ---
...
/**
 * المحرك المركزي (The Injector Engine)
 * يبحث عن أي عنصر يحمل data-icon ويقوم بحقن الـ SVG داخله
 */
const renderIcons = () => {
...
// تفعيل المحرك عند تحميل الصفحة
document.addEventListener('DOMContentLoaded', renderIcons);

// تصدير الوظيفة للاستخدام البرمجي (في حال حقن عناصر جديدة ديناميكياً)
