 ...
 * نسخة الإنتاج الهجينة المحدثة: تدعم الـ ES Modules والـ Script التقليدي معاً
 * التحديث: إضافة أيقونات دعم لوحة التحكم المركزية وبوابة المستثمرين
...
const IconsLibrary = {
    ...
    // --- أيقونات التحكم والتنقل (Navigation & UI) ---
    ...
    // --- أيقونات لوحة التحكم وحالات التنبيهات (Dashboard & Toast Status) ---
    success: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="9 11 12 14 17 9"></polyline></svg>`,
    ...
    wallet: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4"></path><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"></path><path d="M18 12a2 2 0 0 0-2 2c0 1.1.9 2 2 2h4v-4h-4z"></path></svg>`,
    ...
    // --- الأيقونات الجديدة المضافة خصيصاً للمستندات والعمليات الاستثمارية ---
    ...
    trendingUp: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>`,
