/**
 * المخزن المركزي لأيقونات منصة تيرا (Terra Icons Library)
 * تم التحديث ليدعم واجهات المصادقة ولوحة التحكم مع وضوح عالي
 */
const Icons = {
    ...
    // --- أيقونات التحكم والتنقل (Navigation) ---
 ...
 */
const renderIcons = () => {
    // جلب كل العناصر التي تحمل سمة data-icon ولم يتم معالجتها بعد
    ...
    iconElements.forEach(el => {
        ...
        if (Icons[iconName]) {
            ...
            // وضع علامة بأنه تم حقن الأيقونة بنجاح لتجنب تكرار المعالجة
...
// تفعيل المحرك عند تحميل شجرة الصفحة
document.addEventListener('DOMContentLoaded', renderIcons);

// تصدير الوظيفة للنافذة العامة لاستخدامها عند حقن عناصر جديدة (AJAX)
